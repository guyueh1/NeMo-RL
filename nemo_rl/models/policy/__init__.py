...
class Fp8Config(TypedDict):
    ...
    # Match native MXFP4 rollout numerics during Megatron training. Megatron
    # continues to execute its supported MXFP8 kernels, so this mode uses the
    # runtime MXFP4 quantize/dequantize parity patch.
