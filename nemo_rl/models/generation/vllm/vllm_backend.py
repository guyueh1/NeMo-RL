...
class VllmInternalWorkerExtension:
    ...
    def install_mxfp8_bi_emulation_patch(self) -> dict[str, Any]:
        """Install the MXFP8 dequant + BF16 BI matmul patch on vLLM."""
        from nemo_rl.models.generation.vllm.batch_invariant import (
    ...
    def install_mxfp8_bi_cublas_patch(self) -> dict[str, Any]:
        """Install the cuBLAS MXFP8 matmul patch on vLLM."""
        from nemo_rl.models.generation.vllm.batch_invariant import (
            install_mxfp8_bi_cublas_patch,
        )

        return install_mxfp8_bi_cublas_patch(self.model_runner.model)
