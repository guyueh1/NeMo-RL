...
def check_nccl_reshard_refit_support(master_config: Any) -> None:
    ...
    if megatron_enabled:
        ...
        #   MXFP8 storage → logical BF16 → packed MXFP4 gen
        #     (the explicitly gated native MXFP4 path)
                        ...
                        if vllm_cfg.get("mxfp4_moe_weight_native"):
                            if fp8_recipe != "mxfp8":
                                violations.append(
                                    ...
                                    "mxfp4_moe_weight_native=True with "
                            ...
                            violations.append(
                                ...
                                "mxfp4_moe_weight_native=True requests "
